...
# Exercise 1: Write a function that converts a string to an integer and handle both ValueError if the string cannot be converted into an integer and 
# TypeError if the input is not a string. Use multiple except block to handle these exceptions
